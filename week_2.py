...
@app.route('/enigmaC', methods=['GET'])
def hack_caesar_form():
    return render_template('enigmaC.html', users=list(users.keys()))


@app.route('/enigmaC', methods=['POST'])
def hack_caesar():
    global session_id_counter
    data = request.form
    user_id = data['user_id']
...
@app.route('/enigmaV', methods=['GET'])
def hack_vigenere_form():
    return render_template('enigmaV.html', users=list(users.keys()))


@app.route('/enigmaV', methods=['POST'])
def hack_vigenere():
    global session_id_counter
    data = request.form
    user_id = data['user_id']
